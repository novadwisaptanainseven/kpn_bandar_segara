    ...
    <div className="flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
      <div className="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
        <div className="flex flex-col overflow-y-auto md:flex-row">
          <div className="h-32 md:h-auto md:w-1/2 flex justify-center items-center">
            <img
              aria-hidden="true"
              className="object-cover w-32 h-32 md:w-64 md:h-64 dark:hidden"
              // src={ImageLight}
            ...
            <img
              aria-hidden="true"
              className="hidden object-cover w-32 h-32 md:w-64 md:h-64 dark:block"
              src={getImageLogin(dataKonten.logo)}
              alt="Logo"
            />
          </div>
