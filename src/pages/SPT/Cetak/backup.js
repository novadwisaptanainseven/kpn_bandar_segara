{
  this.props.spt.map((item, index) => (
    <div key={index} style={{ width: "279.4mm" }}>
      <div className="border-2 border-black dark:border-gray-300 py-6">
        ...
        <div className="spt-body mx-8 mt-8">
          <div className="flex justify-between">
            <span>
              <b>Tgl. SPT :</b> {format(new Date(item.waktu_buat), "dd/MM/y")}
            </span>
            <span>
              <b>No : </b>
              {item.no_spt}
          ...
          <div className="mt-8 mb-20">
            <table className="w-full" style={{ lineHeight: "2em" }}>
              ...
              <tr>
                ...
                <th align="left">:</th>
                <td align="left">{item.waktu_keberangkatan.toUpperCase()}</td>
              </tr>
              <tr>
