...
import { insertSptTemp } from "../../../../context/actions/SPT_Temp";
...
const ModalEdit = ({ isModalOpen, closeModal, setSptTemp, idPelanggan }) => {
  ...
  const handleFormSubmit = (values) => {
    ...
    insertSptTemp(idPelanggan, values, setLoading, setSptTemp, closeModal);
  };
  ...
  return (
    <>
      <Modal isOpen={isModalOpen.modal} onClose={closeModal}>
              ...
              <form onSubmit={handleSubmit}>
                <ModalBody>
                  ...
                  <Label className="mt-4">
                    ...
                    <br />
                    <HelperText>
                      Total harga bisa diubah. Namun akan mereset potongan harga
                      dan diskon ke 0
                    </HelperText>
                  </Label>
                ...
                <ModalFooter>
                  <div className="mt-5 flex justify-end gap-2">
                    ...
                    <Button type="submit" disabled={loading ? true : false}>
                      {loading ? "Sedang Menambahkan..." : "Tambah"}
                    </Button>
                  </div>
                </ModalFooter>
              </form>
